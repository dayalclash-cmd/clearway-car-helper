  ...
  return (
    <>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center bg-secondary">
        <div className="absolute inset-0 bg-[url('/images/family-car-keys-hero.png')] bg-cover bg-center bg-no-repeat" role="img" aria-label="Happy family receiving car hire keys" />
